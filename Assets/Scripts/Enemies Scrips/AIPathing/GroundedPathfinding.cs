...
[CreateAssetMenu(menuName = "Enemy/Pathfinding/GroundedPathfinding")]
public class GroundedPathfinding : PathfindingStrategy
{
    ...
    private void UpdatePath()
    {
        ...
        seeker.StartPath(enemy.transform.position, enemy.playerPosition.position, p =>
        {
            if (!p.error)
            {
                currentPath.Clear();
